...
TEST(ArrayListTests, Find)
{
	...
	int result = b.find(5, comparisons);
	EXPECT_EQ(result, 0);
	EXPECT_EQ(comparisons, 1);
	result = b.find(5, comparisons);
	EXPECT_EQ(result, 2);
	EXPECT_EQ(comparisons, 2);
	result = a.find(5, comparisons);
	EXPECT_EQ(result, 2);
	EXPECT_EQ(comparisons, 3);
	result = a.find(5, comparisons);
	EXPECT_EQ(result, 4);
	EXPECT_EQ(comparisons, 4);
	result = a.find(5, comparisons);
	EXPECT_EQ(result, 4);
	EXPECT_EQ(comparisons, 5);
	result = a.find(5, comparisons);
	EXPECT_EQ(result, 5);
	EXPECT_EQ(comparisons, 6);
	result = a.find(5, comparisons);
	EXPECT_EQ(result, -1);
	EXPECT_EQ(comparisons, 7);
}
